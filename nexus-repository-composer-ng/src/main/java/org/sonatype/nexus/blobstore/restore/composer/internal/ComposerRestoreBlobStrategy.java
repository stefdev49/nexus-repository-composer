 ...
 */
package org.sonatype.nexus.blobstore.restore.composer.internal;
    ...
    extends BaseRestoreBlobStrategy<DataStoreRestoreBlobData>
{
  ...
  @Inject
  public ComposerRestoreBlobStrategy(
      ...
      @Nonnull final DataStoreRestoreBlobData data)
  {
    ...
    Optional<ComposerContentFacet> facet = repository.optionalFacet(ComposerContentFacet.class);
    if (!facet.isPresent()) {
      ...
      final Blob assetBlob, final DataStoreRestoreBlobData data) throws IOException
  {
    ...
    data.getRepository()
        .facet(ComposerContentFacet.class)
