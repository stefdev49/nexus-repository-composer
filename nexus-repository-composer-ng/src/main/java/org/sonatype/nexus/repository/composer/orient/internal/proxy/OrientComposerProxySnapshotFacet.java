...
import org.sonatype.nexus.repository.composer.orient.internal.snapshot.OrientComposerSnapshotFacetSupport;

/**
 * @since 3.17
 */
@Named
public class OrientComposerProxySnapshotFacet
    extends OrientComposerSnapshotFacetSupport
    implements ComposerSnapshotFacet
{
  ...
  protected List<SnapshotItem> fetchSnapshotItems(final List<ContentSpecifier> specs) throws IOException {
    OrientComposerProxyFacet proxyFacet = getRepository().facet(OrientComposerProxyFacet.class);
