...
/**
 * REST API model for composer-specific proxy attributes.
 *
 * @since 3.20
 */
public class ComposerProxyRepositoriesAttributes
    extends ComposerHostedRepositoriesAttributes
{
  ...
  @JsonCreator
  public ComposerProxyRepositoriesAttributes(
