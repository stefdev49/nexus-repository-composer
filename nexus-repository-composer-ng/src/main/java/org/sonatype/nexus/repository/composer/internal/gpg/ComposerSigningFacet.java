 ...
 */
package org.sonatype.nexus.repository.composer.internal.gpg;
...
/**
 * Signs an Composer metadata by using PGP signing key pair.
 *
 * @since 3.17
 */
@Named
@Facet.Exposed
public class ComposerSigningFacet
    extends FacetSupport
{
  @VisibleForTesting
  static final String CONFIG_KEY = "composerSigning";
  ...
  public Content getPublicKey() throws IOException {
    ...
    return new Content(new BytesPayload(buffer.toByteArray(), ComposerMimeTypes.PUBLICKEY));
  }
