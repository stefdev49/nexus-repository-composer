 ...
 */
package org.sonatype.nexus.repository.composer.orient.internal.proxy;
    ...
    extends ProxyFacetSupport
{
  ...
  protected Content getCachedContent(final Context context) throws IOException {
    return getComposerFacet().get(assetPath(context)).orElse(null);
  }
  ...
  protected Content store(final Context context, final Content content) throws IOException {
    ...
    return getComposerFacet().put(assetPath(context), content);
  }
  ...
  private Optional<SnapshotItem> fetchLatest(final ContentSpecifier spec) throws IOException {
    ...
    Content oldVersion = composerFacet.get(spec.path).orElse(null);
    ...
    if (status.getStatusCode() == HttpStatus.SC_OK) {
      ...
      Content storedContent = getComposerFacet().put(spec.path, fetchedContent);
  ...
  private OrientComposerFacet getComposerFacet() {
    return getRepository().facet(OrientComposerFacet.class);
  }
}
