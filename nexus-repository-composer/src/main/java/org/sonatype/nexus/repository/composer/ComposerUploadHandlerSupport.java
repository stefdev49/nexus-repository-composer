...
/**
 * Common base for an Composer upload handlers
 *
 * @since 3.31
 */
    ...
    extends UploadHandlerSupport
{
  ...
  public ComposerUploadHandlerSupport(final VariableResolverAdapter variableResolverAdapter,
  ...
  {
    ensurePermitted(repository.getName(), ComposerFormat.NAME, assetPath, Collections.emptyMap());
  }
