...
/**
 * Implementation of snapshots for composer proxy repository.
 *
 * @since 3.31
 */
@Facet.Exposed
@Named
public class ComposerProxySnapshotFacet
    extends ComposerSnapshotFacetSupport
{
  ...
  protected List<SnapshotItem> fetchSnapshotItems(final List<ContentSpecifier> specs) throws IOException {
    ComposerProxyFacet proxyFacet = getRepository().facet(ComposerProxyFacet.class);
