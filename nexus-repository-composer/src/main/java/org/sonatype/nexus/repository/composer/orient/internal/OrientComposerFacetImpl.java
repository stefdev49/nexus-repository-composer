...
import org.sonatype.nexus.repository.composer.orient.OrientComposerWritePolicySelector;
 ...
 */
@Named
public class OrientComposerFacetImpl
    extends FacetSupport
    implements OrientComposerFacet
{
  @VisibleForTesting
  ...
  public Content put(final String path, final Payload content, final PackageInfo info) throws IOException {
    ...
    try (final TempBlob tempBlob = storageFacet.createTempBlob(content, ComposerFacetHelper.hashAlgorithms)) {
      ...
      AssetBlob blob = tx.setBlob(
          ...
          path,
          tempBlob,
          ComposerFacetHelper.hashAlgorithms,
          null,
