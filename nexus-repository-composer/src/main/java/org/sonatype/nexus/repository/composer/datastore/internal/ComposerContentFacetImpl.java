 ...
 */
package org.sonatype.nexus.repository.composer.datastore.internal;
...
import static org.sonatype.nexus.repository.composer.internal.ComposerProperties.P_PACKAGE_VERSION;

/**
 * Composer content facet
 *
 * @since 3.31
 */
@Facet.Exposed
    ...
    implements ComposerContentFacet
{
  ...
  @Inject
  public ComposerContentFacetImpl(
  ...
  {
    if (packageInfo == null) {
      packageInfo = ComposerPackageParser.parsePackageInfo(tempBlob);
    }
  ...
  public TempBlob getTempBlob(final Payload payload) {
    ...
    return blobs().ingest(payload, ComposerFacetHelper.hashAlgorithms);
  }

  @Override
  public TempBlob getTempBlob(final InputStream in, @Nullable final String contentType) {
    checkNotNull(in);
    return blobs().ingest(in, contentType, ComposerFacetHelper.hashAlgorithms);
  }
  ...
  @Override
  public Iterable<FluentAsset> getComposerPackageAssets() {
