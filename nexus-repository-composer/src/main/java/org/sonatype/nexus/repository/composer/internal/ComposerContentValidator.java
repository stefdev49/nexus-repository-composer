...
/**
 * Composer-specific {@link ContentValidator} that "hints" default content validator for composer package metadata and format
 * specific files
 *
 * @since 3.17
 */
...
@Singleton
public class ComposerContentValidator
    ...
    implements ContentValidator
{
  ...
  @Inject
  public ComposerContentValidator(final DefaultContentValidator defaultContentValidator) {
