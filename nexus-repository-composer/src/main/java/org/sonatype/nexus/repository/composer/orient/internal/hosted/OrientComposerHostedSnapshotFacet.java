 ...
 */
@Named
public class OrientComposerHostedSnapshotFacet
    extends OrientComposerSnapshotFacetSupport
{
  ...
  private SnapshotItem getItem(final ContentSpecifier spec) throws IOException {
    OrientComposerFacet composer = getRepository().facet(OrientComposerFacet.class);
    Optional<Content> content = composer.get(spec.path);
