    ...
    implements ComponentDirector
{
  ...
  @Inject
  public OrientComposerComponentDirector(final BucketStore bucketStore,
  ...
  public void afterMove(final List<Map<String, String>> components, final Repository destination) {
    ...
    try {
      OrientComposerHostedFacet hostedFacet = destination.facet(OrientComposerHostedFacet.class);
