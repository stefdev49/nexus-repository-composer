 ...
 */
@Named
public class ComposerGroupRepositoryApiRequestToConfigurationConverter
    extends GroupRepositoryApiRequestToConfigurationConverter<ComposerGroupRepositoryApiRequest>
{
  @Override
  public Configuration convert(final ComposerGroupRepositoryApiRequest request) {
    Configuration configuration = super.convert(request);
    configuration.attributes("raw").set(CONTENT_DISPOSITION, request.getComposer().getContentDisposition().name());
