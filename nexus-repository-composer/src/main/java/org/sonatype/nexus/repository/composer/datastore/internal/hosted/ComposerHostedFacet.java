...
/**
 * Composer hosted facet.
 *
 * @since 3.31
 */
@Named
@Exposed
public class ComposerHostedFacet
    extends FacetSupport
{
  ...
  /**
   * Method for triggering Composer metadata recalculation.
   */
  ...
  /**
   * Method for triggering Composer metadata recalculation with possibility to specify what actually asset was changed
   */
